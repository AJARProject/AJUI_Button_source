...
If (Not:C34(OB Is empty:C1297($state_obj.box)))
	...
	End if 
	If ($state_obj.box.bgPrimaryColor#Null:C1517)
		$toDraw_obj.btn.box.bgPrimaryColor:=$state_obj.box.bgPrimaryColor
	End if 
End if 
...
If (Not:C34(OB Is empty:C1297($state_obj.text)))
	...
	End if 
	If ($state_obj.text.marginHorizontal#Null:C1517)
		$toDraw_obj.btn.text.marginHorizontal:=$state_obj.text.marginHorizontal
	End if 
End if 
...
If (Not:C34(OB Is empty:C1297($state_obj.composite)))
	If ($state_obj.composite.padding#Null:C1517)
		$toDraw_obj.btn.composite.padding:=$state_obj.composite.padding
	End if 
	...
	End if 
	If ($state_obj.composite.textAlign#Null:C1517)
		$toDraw_obj.btn.composite.textAlign:=$state_obj.composite.textAlign
	End if 
	...
	End if 
	If ($state_obj.composite.bgSecondaryColor#Null:C1517)
		$toDraw_obj.btn.composite.bgSecondaryColor:=$state_obj.composite.bgSecondaryColor
	End if 
End if 
